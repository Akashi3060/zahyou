...
def build(out_path):
    ...
    add(Paragraph("どちらでも、<b>すでに持っている段は落とし直しません</b>。"
                  "どの段が要るかは 6 章の早見表でも確かめられます。", st.small))
    ...
    ext(h2("暗いところで使う・目標が分からないとき", st, "2.5"))
    ext(bullets([
    ...
    ext(h2("CPU はコア数を増やしても速くなりません", st))
    ...
    ext(callout("表を読まずに済ませたいなら —— 灰色の 2 段以外をぜんぶ", [
