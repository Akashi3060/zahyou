...
> ### ⚠ 初めて実行するとき、青い警告が出ます
>
> 「**Windows によって PC が保護されました**」と表示され、
> 「実行」ボタンが見当たりません。次のようにしてください。
>
> **「詳細情報」をクリック → 現れた「実行」ボタンを押す**
>
> これは **zahyou に開発元の署名（コード署名証明書）が付いていない**ためです。
> 証明書は有料で、個人が配るソフトには付いていないことがよくあります。
> ダウンロードしたファイルには「別の PC から来た」という印が付き、
