...
| zip | 対応する画角 | ASI290MM での焦点距離 | サイズ |
|---|---|---|---|
| `AstrometryData.zip`（基本セット） | 11′ 〜 2000′ | 〜 1750 mm | 869 MB |
| `AstrometryData-index-5204.zip` | 8′ 〜 11′ | 1750 〜 2400 mm | 868 MB |
| `AstrometryData-index-5203.zip` | 5.6′ 〜 8′ | 2400 〜 3450 mm | 1.7 GB |
| `AstrometryData-index-5202.zip` | 4′ 〜 5.6′ | 3450 〜 4830 mm | 3.4 GB |

焦点距離 1200 mm 以下なら基本セットだけで足ります。
画角は `画像の横幅[px] × 206.265 × 画素サイズ[µm] ÷ 焦点距離[mm] ÷ 60` 分角です。
...
| 設定 | 意味 |
|---|---|
| `INPUT_MODE` | 目標を天体名で指定（`'STAR_NAME'`）か、赤経赤緯で指定（`'COORDS'`）か |
